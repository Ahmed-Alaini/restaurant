        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/icn.svg" alt=""> </a>
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="meals.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite food</a></li>
...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="meals.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["d_id"]; ?>" >
										<i class="fa fa-trash pull-right"></i></a>
										</div>
										
                                        <div class="form-group row no-gutter">
                                            <div class="col-xs-8">
                                                 <input type="text" class="form-control b-r-0" value=<?php echo "SAR".$item["price"]; ?> readonly id="exampleSelect1">
...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        <p>TOTAL</p>
                                        <h3 class="value"><strong><?php echo "SAR".$item_total; ?></strong></h3>
                                        <p>Free Delivery!</p>
                                        <?php
                                        if($item_total==0){
                                        ?>
                    ...
                    <div class="col-md-8">
						...
						<?php  
									$stmt = $db->prepare("select * from meals where rs_id='$_GET[res_id]'");
									$stmt->execute();
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<form method="post" action='meals.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="admin/Res_img/meals/'.$product['img'].'" alt="Food logo">'; ?></a>
                                            </div>
										...
										<span class="price pull-left" >SAR<?php echo $product['price']; ?></span>
