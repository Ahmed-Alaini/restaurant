...
.navbar-dark .navbar-nav .nav-link.active:focus, .navbar-dark .navbar-nav .nav-link.active:hover {color:  #264790;}
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo.svg" alt=""> </a>
        ...
        <section class="hero bg-image" data-image-src="images/img/Background.png">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order Delivery for University Students & Take-Out </h1>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Meals of the Month</h2>
                    <p class="lead">Easiest way to order your favourite food among these top 6 Meals</p>
                </div>
                <div class="row">
						 <?php
$query_res = mysqli_query($db, "SELECT * FROM meals ORDER BY RAND() LIMIT 6");
while ($r = mysqli_fetch_array($query_res)) {
    if (!empty($r['img']) && !empty($r['title'])) {  // التحقق من وجود الصورة والعنوان
        echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                <div class="food-item-wrap">
                    <div class="figure-wrap bg-image" data-image-src="admin/Res_img/meals/' . $r['img'] . '"></div>
                    <div class="content">
                        <h5><a href="meals.php?res_id=' . $r['rs_id'] . '">' . $r['title'] . '</a></h5>
                        <div class="product-name">' . $r['slogan'] . '</div>
                        <div class="price-btn-block"> 
                            <span class="price">SAR' . $r['price'] . '</span> 
                            <a href="meals.php?res_id=' . $r['rs_id'] . '" class="btn theme-btn-dash pull-right">Order Now</a> 
                        </div>
                    </div>
                </div>
            </div>';
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="meals.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Restaurant logo"> </a>
																</div>
													
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="meals.php?res_id='.$rows['rs_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].'</span>
																</div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p> Al-Madina Al-Munawwara </p>
                                    <h5>Phone:  966 xxx xxx xxx </a></h5> </div>
