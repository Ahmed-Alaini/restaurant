...
$status=$_POST['status'];
$remark=$_POST['remark'];
$query=mysqli_query($db,"insert into feedback(frm_id,status,remark) values('$form_id','$status','$remark')");
...
<table  border="0" cellspacing="0" cellpadding="0">
    ...
    <option value="closed">Delivered</option>
	 <option value="rejected">Cancelled</option>
      ...
      <tr >
      <td><b>Message</b></td>
      <td><textarea name="feedback" cols="50" rows="10" required="required"></textarea></td>
    </tr>
